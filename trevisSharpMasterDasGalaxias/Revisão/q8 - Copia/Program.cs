...
var X = new DeathChance();
printDistribuition(X.Sample(100), 0.1f);
...
public abstract class RandomVariable
{
    ...
    {
        SumVariable sum = new SumVariable();
        sum.X = this;
        sum.Y = Y;
        return sum;
    }
    ...
    {
        SampleVariable sample = new SampleVariable();
        sample.X = this;
        sample.Size = size;
        return sample;
    }
...
public class SumVariable : RandomVariable
{
    public RandomVariable X { get; set; }
    public RandomVariable Y { get; set; }
...
public class SampleVariable : RandomVariable
{
    public RandomVariable X { get; set; }
